...
.tabs{display:flex;gap:5px;min-width:0;overflow-x:auto;scrollbar-width:none}.tabs::-webkit-scrollbar{display:none}.tab{height:32px;border:1px solid transparent;background:transparent;color:var(--muted);border-radius:6px;padding:0 10px;flex:0 0 auto}.tab.active{background:var(--panel2);color:var(--text);border-color:var(--line)}
